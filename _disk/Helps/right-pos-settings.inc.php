...
if($read->getResult()):
    ?>
    <a href="javascript:void" class="btn btn-primary" onclick="FinalizarVenda()">Finalizar Venda</a>
    <?php
else:
    ?>
    <a href="javascript:void()" onclick="DadosDaFactura()" class="btn btn-default">Processar</a>
    <?php
endif;
?>