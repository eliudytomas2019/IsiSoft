                        ...
                        if($read->getResult()):
                            ...
                            if($datab['ano'] <= date('Y') && $datab['mes'] != date('m')):
                                ...
                                try{
                                    ...
                                    $mail->Body    = "
                                        ...
                                        <p style='margin: 0px 25%!important;text-align: justify!important;'>Prezado(a) Sr.(a) <strong>{$item['nome']}</strong> foi convidado(a) a experimentar o nosso software de faturação e gestão de estoque. IsiSoft, certificado pela AGT.</p><br/>
                                        ...
                                        <p style='margin: 0px 25%!important;text-align: justify!important;'>Para criar a sua conta basta apenas aceder o link: <a href='https://IsiSoft.ao/_register.php' target='_blank'>https://IsiSoft.galeranerd.ao/_register.php</a></p><br/>
                                        <p style='margin: 0px 25%!important;text-align: justify!important;'>Durante este período, vamos enviar alguns e-mails para lhe dar a conhecer algumas funcionalidades do IsiSoft, para que possa tirar o máximo proveito do nosso software. </p><br/>
                                        <p style='margin: 0px 25%!important;text-align: justify!important;'>Recomendamos a utilização do browser Google Chrome para que tire totalmente partido do IsiSoft.</p><br/>
                            ...
                            try{
                                ...
                                $mail->Body    = "
                                    ...
                                    <p style='margin: 0px 25%!important;text-align: justify!important;'>Prezado(a) Sr.(a) <strong>{$item['nome']}</strong> foi convidado(a) a experimentar o nosso software de faturação e gestão de estoque. IsiSoft, certificado pela AGT.</p><br/>
                                    <p style='margin: 0px 25%!important;text-align: justify!important;'>Nos próximos 30 dias poderá experimentar o nosso Software de Faturação Online, sem qualquer restrição e de forma totalmente gratuita!</p><br/>
                                    <p style='margin: 0px 25%!important;text-align: justify!important;'>Para criar a sua conta basta apenas aceder o link: <a href='https://IsiSoft.galeranerd.ao/_register.php' target='_blank'>https://IsiSoft.galeranerd.ao/_register.php</a></p><br/>
                                    <p style='margin: 0px 25%!important;text-align: justify!important;'>Durante este período, vamos enviar alguns e-mails para lhe dar a conhecer algumas funcionalidades do IsiSoft, para que possa tirar o máximo proveito do nosso software. </p><br/>
                                    <p style='margin: 0px 25%!important;text-align: justify!important;'>Recomendamos a utilização do browser Google Chrome para que tire totalmente partido do IsiSoft.</p><br/>
                                    <p style='margin: 0px 25%!important;text-align: justify!important;'>Se necessitar de ajuda, para o esclarecimento de dúvidas ou questões, temos uma equipa de suporte dedicada, dias úteis das 10:00-18:00, que poderá contactar  por chat, por email ({$Index['email']}) ou através do telefone ({$Index['telefone']}).</p><br/>
                                    <p style='margin: 0px 25%!important;text-align: justify!important;'>Obrigado,</p><br/>
