...
<head>
    ...
    <link rel="stylesheet" href="_disk/css/login.css" />

    <?php require_once("plafaforms.inc.php"); ?>
</head>
<body class="antialiased d-flex flex-column">
<div class="IsiSoftLogin">
    <div class="IsiSoftLoginInfo">
        <div class="IsiSoftLoginInfo-one">
            <h1><?= $Index['name']; ?></h1>
            <h2>Software Certificado nº <?= $Index['agt']; ?></h2>
        </div>
        <div class="IsiSoftLoginInfo-two">
            <label>
                <h6>Call Center</h6>
                <span><i class="fa fa-whatsapp"></i> <?= $Index['telefone']; ?></span>
            </label>
            <label>
    ...
    <div class="IsiSoftLoginForm">
        <div class="text-center mb-4">
            <a href=""><img src="uploads/<?= $Index['logotype']; ?>" height="76" alt=""></a>
        </div>
        <form name="FormCreateAccounting" action="#getResult" method="post">
            <div class="card-body">
        ...
        <div class="text-center text-muted mt-3 vx-toyota">
